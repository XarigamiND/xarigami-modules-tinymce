 ...
 * Updated for xarigami with upstream version 2.0.5
 */
...
class TinyMCE_Compressor {
	...
	//Start Xarigami changes .. gee what can we do here
    ...
    $settings['cache_dir'] = $realpath.'/var/cache/templates';  //ToDo: we need to set this for tinymce
    // Cache path, this is where the .gz files will be stored
    //finish Xarigami changes
