...
arrLoremIpsumTexts.push('Xarigami Open Source web application framework written in PHP and licensed under the GNU General Public License. |Xarigami delivers the requisite infrastructure and tools to create custom web applications that include fully dynamic multi-platform Content Management Solutions (CMS).|Xarigami\'s modular, database independent architecture introduces tools that separate form, function, content, and design with on-the-fly extensions allowing greater control and versatility.');arrLoremIpsumLangs.push('English');
